...
// import chartDashboard from '../../assets/images/illustration-no-product-chart-dashboard.svg'
import { Link } from "react-router-dom";

export default function ProductOverview() {
  return (
    <div className="border-white-2 bdrs10 main-shadow block-widget">
      <div className="top-row">
        <div className="top-row__left">
          <h3 className="mb-0 fz14 fw500">Product Overview</h3>
      ...
      {/* <!-- <div className="noData-chart_bar">
                  <h2 className="fw300 text-center fz26">
                    No Data Found <br>
