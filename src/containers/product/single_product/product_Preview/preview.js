    ...
    <div className="block-wavy-dark product-screen__graphics">
      <div className="dark-block-content">
        <h3 className="fz24 mb-0 fw600 gradientText--radial">
          ...
          <span>Your product will look like this</span>
        </h3>
        <p className="fz12 text-white">
          The overview of your product is here
      ...
      <div className="cta-row">
        <Link to="/add-product" class="btn btn-cta--outlined">
        ...
        <Link to="/QR-generated" className="btn btn-cta--outlined">
          <div className="fw400 fz14">
            <div className="gradientText--radial">
              <span>Proceed</span>
            </div>
