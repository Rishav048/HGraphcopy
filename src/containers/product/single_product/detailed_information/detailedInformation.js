...
export default function DetailedInformation({ handleSubmit }) {
  return (
    <div className="block-wavy-dark product-screen__graphics">
      <div className="dark-block-content">
        <h3 className="fz24 mb-0 fw600 gradientText--radial">
          ...
          <span>Add detailed information.</span>
        </h3>
        <p className="fz12 text-white">
          Add description about your product and other data to sepecify more.
      ...
      <div className="cta-row">
        <div className="btn btn-cta--outlined">
          <div onClick={handleSubmit} className="fw400 fz14">
